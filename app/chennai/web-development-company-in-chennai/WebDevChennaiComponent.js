...
import WebDevdetChennai from "./WebDevChennai/page";
import HeroWebDevChennai from "./WebDevHeroChennai/page";
...
function WebDevChennaiComponent() {
  return (
    <div>
...
export default WebDevChennaiComponent;
