              ...
              <div className="services-icons4">
                <div className="services-icons-card">
                  <div className="group-iconsss">
                    <img src='https://res.cloudinary.com/dd9tagtiw/image/upload/v1739428649/services-group2345_ipa2bs.png'      max-width=" 400px"
    width= "100%" alt="Our Technologies" title="Our Technologies" />
                  </div>
