...
import DetailShopIndia from "./DetailShopIndia/page";
import HeroSectionShopIndia from "./HeroShopIndia/page";
...
function ShopifyIndiaComponent() {
  return (
    <div>
      <div className="ser-main"></div>

      <Navbar />
      <HeroSectionShopIndia />
      <DetailShopIndia />
...
export default ShopifyIndiaComponent;
