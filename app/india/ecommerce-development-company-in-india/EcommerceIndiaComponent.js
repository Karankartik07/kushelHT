...
import DetailEcomIndia from "./DetailEcomIndia/page";
import HeroSectionEcomIndia from "./HeroEComIndia/page";
...
function EcommerceIndiaComponent() {
  return (
    <div>
      <div className="ser-main"></div>

      <Navbar />
      <HeroSectionEcomIndia />
      <DetailEcomIndia />
...
export default EcommerceIndiaComponent;
