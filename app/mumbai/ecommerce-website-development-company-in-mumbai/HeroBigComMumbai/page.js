...
export default function HeroEcomMum() {
    ...
    <section className="hero-bigCom">
      <div className="overlay-black">
        <div className="containerN">
          ...
          <div className="leftN">
            <h1>
            Choosing the Right E-Commerce Platform is Harder Than It Looks
            </h1>
            <p>
              
Every option—BigCommerce, Shopify, and Magento—comes with hidden trade-offs. The wrong choice can stall your growth, while the right one can future-proof your brand.
            ...
            <ul className="features">
              <li className="feat-icon">
                ...
                <img src="https://res.cloudinary.com/dxlykgx6w/image/upload/v1756447593/next_1_fmsl3r.png" />{" "}
              	Honest insights into BigCommerce, Shopify & Magento platforms
              ...
              <li className="feat-icon">
                {" "}
                <img src="https://res.cloudinary.com/dxlykgx6w/image/upload/v1756447593/next_1_fmsl3r.png" />{" "}
             Avoid costly rebuilds with the right platform decision

              </li>
              <li className="feat-icon">
                {" "}
                <img src="https://res.cloudinary.com/dxlykgx6w/image/upload/v1756447593/next_1_fmsl3r.png" />{" "}
              	Future-proof your e-commerce growth with expert guidance
              </li>
            </ul>
            ...
            <div className="buttons">
              <Link href={"/contact-us"}>
                <button className="btnNew blue">Get a Free Consult Today </button>
              </Link>
              <Link
