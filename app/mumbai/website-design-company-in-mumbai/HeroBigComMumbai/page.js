    ...
    <section className="hero-bigCom">
      <div className="overlay-black">
        <div className="containerN">
          {/* Left Section */}
          <div className="leftN">
            <h1>Design That Builds Trust and Drives Growth</h1>
            <p>
              A great website does more than look good — it makes people trust
              your brand and take action. We create websites that are clean,
              professional, and built to support your business goals.
            </p>
            ...
            <ul className="features">
              <li className="feat-icon">
                ...
                Modern, brand-focused designs that leave a lasting impression
             ...
             Smooth, responsive experience across devices
              ...
              <li className="feat-icon">
                {" "}
                <img src="https://res.cloudinary.com/dxlykgx6w/image/upload/v1756447593/next_1_fmsl3r.png" />{" "}
              	User-friendly layouts that turn visitors into customers
              </li>
            </ul>
